...
int output = targetSavingsGoal/savingspermonth;
System.out.println("Months needed " + "" + output);
    ...
    String word4 = "using";
    String word5 = "15";
    String word6 = "different ";
    String word7 = "words";
    String word8 = "assigning";
    String word9 = "them";
    String word10 = "to";
    String word11 = "strings";
    String word12 = "3";
    String word13 = "times";
    String word14 = "5";
    String word15 = "done";
    
    System.out.println(word1 + " " + word3 + " " + word9);
    System.out.println(word1 + " " + word13 + " " + word4);
    System.out.println(word5 + " " + word8 + " " + word7);
...
Boolean hasboyfriend = false;
    ...
    if(hasjob || hasmoney) {
        ...
        System.out.println("I can be independent.");
    }
